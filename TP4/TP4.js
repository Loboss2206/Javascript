...
var personne1 = new Personne("Doe", "John");
personne1.manger("pomme");
personne1.manger("poire");
personne1.manger("banane");
personne1.manger("orange");
personne1.manger("kiwi");
personne1.manger("ananas");
personne1.manger("raisin");
personne1.manger("fraise");
personne1.manger("framboise");
personne1.manger("myrtille");
personne1.manger("mûre");
personne1.name();
personne1.digestionOK();
...
let monBebe = new Baby("Dupont", "Pierre", 1, "bleus", "le ballon");
monBebe.manger("compote de pommes"); // Affiche "Miam ! J'ai mangé compote de pommes"
monBebe.digestionOK(); // Affiche "Je me sens mieux maintenant !"
monBebe.name(); // Affiche "Je m'appelle Pierre Dupont"
monBebe.jouer(); // Affiche "Je joue avec mon jouet favori le ballon"